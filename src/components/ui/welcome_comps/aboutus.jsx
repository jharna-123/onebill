  ...
  return (
    <div className=''>
        ...
        <div className="flex flex-col mt-6 mb-20">
            <h1 className="shrink-0 w-[335] h-[76] font-sans text-center  text-[64px] leading-normal font-bold">About Us</h1>
            <p className='shrink-0 text-center text-[24px] leading-normal'>Powerful, easy-to-use billing software to help you growing your business.</p>
        </div>
        ...
        <div className="grid grid-cols-2  h-[720px] bg-gradient-to-b from-[#d9d9d900] to-[#3a3a3a19]">
            ...
            <div className='flex flex-col gap-14 p-8 relative'>
                <br></br>
                <h2 className='shrink-0 w-[645px] font-sans h-[116px]  text-[48px] leading-tight font-bold absolute top-20 left-40'>We are specialist in managing your business</h2>
                <p className='shrink-0 w-[579px] h-[174px] text-justify leading-normal font-[24px] absolute top-60 left-40'>Built with modern businesses in mind, our solution integrates seamlessly with accounting systems, CRMs, ERPs, and e-commerce platforms. Whether you're a freelancer, a small business, or an enterprise, our tools help you stay compliant, reduce manual errors, and improve cash flow management.
